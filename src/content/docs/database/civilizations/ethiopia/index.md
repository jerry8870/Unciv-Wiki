...
{
  "title": "Ethiopia",
  "description": "Ethiopia: base values, rules and related civilizations in Unciv.",
  "gameVersion": "4.21.20",
  "appBuild": 1293,
...
<span class="database-icon-frame"><img class="database-icon" src="/Unciv-Wiki/game-assets/nation/ethiopia.png" alt="Ethiopia" width="80" height="80" loading="lazy" decoding="async" /></span>
...
- [Stele](/Unciv-Wiki/database/buildings/stele/)
