---
{
  ...
  "description": "Great Merchant: base values, rules and related units in Unciv.",
  "gameVersion": "4.21.20",
  "appBuild": 1293,
...
<span class="database-icon-frame"><img class="database-icon" src="/Unciv-Wiki/game-assets/unit/great-merchant.png" alt="Great Merchant" width="80" height="80" loading="lazy" decoding="async" /></span>
...
- [This Unit] gets a name from the [Merchant] group
- Great Person - [Gold]
- Unbuildable
- Uncapturable
